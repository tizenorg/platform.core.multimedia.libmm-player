...
#include "utc_mm_player_resume_func.h"



struct tet_testlist tet_testlist[] = {
	{utc_mm_player_resume_func_01, 1},
	{utc_mm_player_resume_func_02, 2},	
	{NULL, 0}
};


GMainLoop *g_resume_loop;
bool g_is_resume_positive = 0;
...
void utc_mm_player_resume_func_01()
{
	...
	UTC_MM_PLAYER_RUN_LOOP(g_resume_loop);
...
/**
* @brief 		This tests int mm_player_resume() API with invalid parameter
* 			Create a player handle with a NULL out param
* @par ID	utc_mm_player_resume_func_02
* @param	[in] &player = NULL
* @return	error code on success 
*/
void utc_mm_player_resume_func_02()
{	 
	MMHandleType player = 0;
	int ret = 0;
