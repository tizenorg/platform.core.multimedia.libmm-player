...
#include "utc_mm_player_stop_func.h"




struct tet_testlist tet_testlist[] = {
	{utc_mm_player_stop_func_01, 1},
	{utc_mm_player_stop_func_02, 2},	
	{NULL, 0}
};

GMainLoop *g_stop_loop;
...
void utc_mm_player_stop_func_01()
{
	...
	UTC_MM_PLAYER_RUN_LOOP(g_stop_loop);
...
/**
* @brief 		This tests int mm_player_stop() API with invalid parameter
* 			Create a player handle with a NULL out param
* @par ID	utc_mm_player_stop_func_02
* @param	[in] &player = NULL
* @return	error code on success 
*/
void utc_mm_player_stop_func_02()
{	
	MMHandleType player = 0;
	int ret = 0;
