...
#include "utc_mm_player_get_state_func.h"

struct tet_testlist tet_testlist[] = {
	{utc_mm_player_get_state_func_01, 1},
	{utc_mm_player_get_state_func_02, 2},		
	{NULL, 0}
};


/**
* @brief	This tests int mm_player_get_state() API with valid parameter
* 		Create a player handle with valid parameter & Test the handle by playing
* @par ID	utc_mm_player_get_state_func_01
* @param	[in] &player = handle of player to be populated
* @return	This function returns zero on success, or negative value with error code
*/
void utc_mm_player_get_state_func_01()
{ 
	...
	ret = mm_player_get_state(player, &state);
...
/**
* @brief 		This tests int mm_player_get_state() API with invalid parameter
* 			Create a player handle with a NULL out param
* @par ID	utc_mm_player_get_state_func_02
* @param	[in] &player = NULL
* @return	error code on success 
*/
void utc_mm_player_get_state_func_02()
{	
	MMHandleType player = 0;
	int ret = 0;
	...
	ret = mm_player_get_state(player, NULL);
